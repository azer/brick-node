...
function container (brick, body, options) {
  var vars = {
    'title': brick.title,
    'name': brick.name,
    'body': body,
    'js': wrappers['js.html'](path.join(options.dir || "", brick.assetsDir, 'bundle.js')),
    'css': wrappers['stylesheet.html'](path.join(options.dir || "", brick.assetsDir, 'bundle.css')),
    'after': '',
